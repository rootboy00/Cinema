...
begin
  ...
  begin
    IBQuery1.SQL.Add
      ('INSERT INTO HALL(NAME,DESCRIPTION) VALUES (:NAME,:DESCRIPTION)');
  end
  else
  begin
    IBQuery1.SQL.Add
      ('UPDATE HALL SET NAME = :NAME, DESCRIPTION = :DESCRIPTION');
  end;
...
begin
  ...
  begin
    ...
    UHallChange.Form9.Caption:= 'Добавить Зал';
  end
  else
  begin
    ...
    UHallChange.Form9.Caption:= 'Изменить Зал (' + edit1.Text + ')';
