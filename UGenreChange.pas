...
begin
  ...
  begin
    ...
    begin
      showmessage('Извини, но жанр с названием '+ edit1.text +' уже есть в базе данных');
    end;
...
case texttype of
0:  begin
  str:= 'Добавить новый жанр';
  edit1.Text:= 'Введите название нового жанра';
  button2.Visible:= false;
  button1.Caption:= 'Добавить';
end;
else
begin
  str:= 'Изменить название ('+GenreName+')';
