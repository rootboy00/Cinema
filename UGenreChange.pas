...
edit1.Text:='';
  ...
  if(GenreID = 0) then
  begin
    Label1.Caption:= 'Введи имя новому жанру';
    button1.Caption:= 'Добавить';
    UGenreChange.Form5.Caption:= 'Добавить Жанр';
  end else
  begin
    ibquery1.SQL.Clear;
    ...
    Label1.Caption:= 'Изменить Имя (' + ibquery1.Fields[0].AsString +' )';
    button2.Caption:= 'Удалить';
    button1.Caption:='Изменить';
    UGenreChange.Form5.Caption:= 'Изменить (' + edit1.Text + ')';
